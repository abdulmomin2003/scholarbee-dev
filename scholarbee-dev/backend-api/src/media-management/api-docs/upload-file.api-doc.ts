...
export function UploadFileApiDoc() {
  return applyDecorators(
    ApiBearerAuth(),
    ApiOperation({
      summary: 'Upload public asset',
      description: 'Upload a file and make it publicly accessible. File will be made public and accessible via direct URL. Use this endpoint for public assets like campus logos, university logos, scholarship images, organization logos, etc. Maximum file size: 2MB. Requires authentication.'
    }),
